(function () {
  ...
  function renderPageHero() {
    ...
    return '<section class="page-hero page-hero-booking"><div class="container page-hero-grid"><div class="page-hero-copy"><div class="hero-prelude"><span class="hero-chip">Direkt Rezervasyon</span><span class="hero-rule"></span><span class="hero-annotation">Planlamanizi otel ofisiyle net, hizli ve guvenli bir akista ilerletin</span></div><p class="kicker">Rezervasyon</p><h1 class="hero-title room-page-title">Konaklamanizi profesyonel bir akisla planlayin</h1><p class="hero-text">Giris ve cikis tarihinizi, oda seciminizi, misafir bilgilerinizi ve ozel taleplerinizi tek formda iletin. Ekibimiz size secilen iletisim kanali uzerinden kisa surede geri donus saglasin.</p><div class="hero-actions"><a class="button button-primary" href="#rezervasyon-formu">Formu Doldurmaya Basla</a><a class="button button-secondary" href="https://wa.me/' + Data.escapeHtml(state.hotel.whatsappNumber.replace(/[^\d]/g, '')) + '">WhatsApp ile Yaz</a></div><div class="hero-signature-grid"><article class="hero-signature-card"><span>Direkt Hat</span><strong>' + Data.escapeHtml(state.hotel.phone) + '</strong></article><article class="hero-signature-card"><span>Donus Kanali</span><strong>Telefon veya WhatsApp</strong></article><article class="hero-signature-card"><span>Baslangic Fiyat</span><strong>' + Data.formatMoney(state, Data.getStartingPrice(state)) + '</strong></article></div></div><aside class="page-hero-aside"><article class="contact-card"><p class="section-kicker">Rezervasyon Ofisi</p><h3>Hizli planlama notlari</h3><div class="summary-line"><span>Check-in</span><strong>' + Data.escapeHtml(state.hotel.checkInTime) + '</strong></div><div class="summary-line"><span>Check-out</span><strong>' + Data.escapeHtml(state.hotel.checkOutTime) + '</strong></div><div class="summary-line"><span>Kahvalti</span><strong>' + Data.escapeHtml(state.hotel.breakfastHours) + '</strong></div><div class="summary-line"><span>Donus</span><strong>Ayni gun teyit hedefi</strong></div>' + (selected ? '<div class="summary-divider"></div><div class="summary-line"><span>Secili oda</span><strong>' + Data.escapeHtml(selected.name) + '</strong></div><div class="summary-line"><span>Kapasite</span><strong>' + Data.escapeHtml(roomCapacityLabel(selected)) + '</strong></div>' : '') + '</article></aside></div></section>';
  }
  ...
  function renderApp() {
    return '<div class="shell">' +
      ...
      Shell.renderFloatingActions(state, { primaryHref: '#rezervasyon-formu', primaryTitle: 'Rezervasyon', primaryLabel: 'Formu Doldur', secondaryLabel: 'Hemen Yaz' }) +
      '</div>';
  }
