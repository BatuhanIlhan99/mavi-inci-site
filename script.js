...
(function () {
  ...
  var testimonials = [
    ...
    { score: 'Tekrar geliriz', title: 'Ailece cok rahat ettik', text: 'Suit oda ferah, ekip hizli ve kahvalti gercekten doyurucuydu.', guest: 'Yildiz Ailesi' }
  ];
  ...
  var faqs = [
    ...
    { title: 'Cocuklu konaklamalarda hangi oda daha uygun?', text: 'Aileler icin en rahat secenek genellikle Suit odadir.' }
  ];
  ...
  function initializeForms() {
    ...
    bookingForm.addEventListener('submit', function (event) {
      ...
      showToast('Rezervasyon talebi admin paneline eklendi. Ref: ' + reference);
      setBookingStep(3);
      updateSummary();
    });
  ...
  function refreshStateFromStorage(showNotice) {
    ...
    mount(snapshot);
    if (showNotice) showToast('On yuz verileri admin panelinden guncellendi.');
  }
