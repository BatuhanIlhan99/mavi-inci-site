(function (window, document) {
  ...
  function renderFallback(message) {
    ...
    root.innerHTML = '' +
      ...
      '<p style="margin:0 0 12px;font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#5f8ea2;">Mavi Inci Park Otel</p>' +
      ...
      '<p style="margin:12px 0 0;font-size:16px;line-height:1.75;color:#4b6877;">Rezervasyon ve bilgi almak icin telefon ya da WhatsApp hattimizdan bize hemen ulasabilirsiniz.</p>' +
      ...
      '<a href="./odalar.html" style="display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border-radius:999px;background:#ffffff;color:#143646;text-decoration:none;font-weight:700;border:1px solid rgba(20,54,70,0.16);">Odalar</a>' +
      '<a href="./rezervasyon.html" style="display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 18px;border-radius:999px;background:#ffffff;color:#143646;text-decoration:none;font-weight:700;border:1px solid rgba(20,54,70,0.16);">Rezervasyon</a>' +
