(function () {
  ...
  function renderStayPreview() {
    ...
    return '<section class="section section-light section-stay-preview"><div class="container"><div class="section-header"><p class="section-kicker">Odalarimiz</p><h2 class="section-title">Modern imkanlarla donatilmis konforlu oda secenekleri</h2><p class="section-text">Her oda tipimizi temiz, bakimli ve islevsel bir konaklama deneyimi sunacak sekilde hazirladik. Oda sayfamizdan detaylari inceleyebilir, size uygun secenegi kolayca belirleyebilirsiniz.</p></div><div class="stay-preview-grid">' + rooms.map(renderStayPreviewCard).join('') + '</div><div class="section-cta-row"><a class="button button-primary" href="' + Shell.pageHref('rooms') + '">Tum Oda Tiplerini Gorun</a><a class="button button-secondary" href="' + Shell.pageHref('booking') + '">Rezervasyon Planlayin</a></div></div></section>';
  }
